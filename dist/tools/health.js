...
const scorer_js_1 = require("../lib/audit/scorer.js");
async function getHealthScore(repoRoot, files) {
    const health = await (0, scorer_js_1.computeHealthScore)(repoRoot, files);
